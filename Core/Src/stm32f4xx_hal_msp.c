...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA5     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOA, Battery_Voltage_Pin|Front_Right_Receiver_Pin|Side_Right_Receiver_Pin|Side_Left_Receiver_Pin
                          |Front_Left_Receiver_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, Gyro_SCL_Pin|Gyro_ADO_Pin|Gyro_SDA_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM2)
  {
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(Left_EncoderA_GPIO_Port, Left_EncoderA_Pin);

    HAL_GPIO_DeInit(Left_EncoderB_GPIO_Port, Left_EncoderB_Pin);
