...
static float Kp_e = 0.02f;   // Proportional on rate error (PWM per count/s)
static float Ki_e = 0.0f;    // Integral on rate error
static float Kd_e = 0.1f;    // Derivative on rate error
